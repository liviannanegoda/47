...
import com.github.yuliyaks.service.impl.NoteServiceImpl;
...
@SpringBootTest
@AutoConfigureTestDatabase(replace = AutoConfigureTestDatabase.Replace.NONE) // Использовать БД, что и в основном классе
@DirtiesContext(classMode = DirtiesContext.ClassMode.AFTER_EACH_TEST_METHOD) // Очищать БД после каждого теста
